...
router.get('/heatmap', adminController.heatmap);
router.get('/users', adminController.users);
router.get('/users/:id/detail', validate({ params: z.object({ id: mongoIdSchema }) }), adminController.userDetail);
...
router.patch('/courses/:id', validate({ body: updateCourseSchema }), adminController.updateCourse);
router.delete('/courses/:id', validate({ params: z.object({ id: mongoIdSchema }) }), adminController.deleteCourse);
router.get('/quizzes', adminController.quizzes);
router.get('/quizzes/:id/review', validate({ params: z.object({ id: mongoIdSchema }) }), adminController.quizReview);
